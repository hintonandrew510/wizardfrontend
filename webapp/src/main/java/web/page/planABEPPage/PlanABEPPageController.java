...
public class PlanABEPPageController {
	...
	private static final Logger mLog = LoggerFactory.getLogger(PlanABEPPageController.class.getName());
	...
	public String detail(Model model, @RequestParam String ID, HttpSession session) {
		...
		WizardData wizardData = wizardDataRepository.findByPagesequenceAndWizardid(Pages.PlanABEPPage.getPageSequence(),
				wizard.getWizardid());
		PlanABEPPageModel dataPageModel = null;
		if (wizardData != null) {
			dataPageModel = (PlanABEPPageModel) JSONManager.convertFromJson(wizardData.getPagedata(),
	...
	public String save(@RequestParam String wizardId, @RequestParam String wizarddataid,
		...
		PlanABEPPageModel pageModel = new PlanABEPPageModel(planAAverageSale, planAGrossMargin, planAClosingPct,
				planAProspectValue, planAInvestment, planAProspectsNeeded, planAProspectSalesNeeded,
				planAGrossProfitOnSales, planAMonths, planAAdditionalGrossSales);
