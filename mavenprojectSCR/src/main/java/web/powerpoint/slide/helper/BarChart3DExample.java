...
public class BarChart3DExample {
    public static void main(String[] args) {
        try {
            ...
            dataset.addValue(46, "Gold Medals", "USA");
             dataset.addValue(26, "Silver Medals", "USA");
             dataset.addValue(26, "bronse Medals", "USA");
            dataset.addValue(38, "Gold Medals", "China");
            dataset.addValue(29, "Gold Medals", "UK");
            dataset.addValue(22, "Gold Medals", "Russia");
